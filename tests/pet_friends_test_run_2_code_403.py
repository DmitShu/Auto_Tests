...
def test_add_new_pet_with_invalid_key(name=add_name, animal_type=add_animal_type,
    ...
    """Проверяем что добавить питомца с корректными данными из settings.py и неверным ключом нельзя"""
...
def test_update_pet_info_with_invalid_key(name=upd_name, animal_type=upd_animal_type, age=upd_age,
    ...
    """Проверяем что изменить питомца с корректными данными из settings.py и неверным ключом нельзя"""
...
def test_add_pet_photo_with_invalid_key(pet_photo=add_pet_photo3):
    """Проверяем что изменить фото питомца с корректными данными и неверным ключом нельзя"""
